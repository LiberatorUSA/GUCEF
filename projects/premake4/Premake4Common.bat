...
IF NOT DEFINED PM4TARGETDIR (
  ECHO PM4TARGETDIR environment variable not found, setting it
  SET PM4TARGETDIR=%GUCEF_HOME%\common\bin\premake4
)
IF DEFINED PM4TARGETSUBDIR (
  ECHO PM4TARGETSUBDIR environment variable found, appending premake4 output path
  SET PM4TARGETDIR=%PM4TARGETDIR%\%PM4TARGETSUBDIR%
)
