...
class GUCEF_COMCORE_EXPORT_CPP CIPubSubMsg : public CORE::CICloneable
{
    ...
    typedef std::pair< CORE::TLinkedCloneableBuffer, CORE::TLinkedCloneableBuffer > TKeyValuePair;
    typedef std::vector< TKeyValuePair > TKeyValuePayload;
    ...
    virtual const TKeyValuePayload& GetKeyValuePairs( void ) const = 0;
