...
{GUCEF_TRACE;
    ...
    GUI::CGuiGlobal::Instance()->GetWindowManager().RegisterBackend( "Win32GL", win32GlWindowManager );
    return 1;
}
...
{GUCEF_TRACE;
    ...
    GUI::CGuiGlobal::Instance()->GetWindowManager().UnregisterBackend( "Win32GL" );
}
