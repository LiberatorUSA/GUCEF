...
typedef CORE::CTFactoryWithParam< COMCORE::CPubSubClient, CMsmqPubSubClient, COMCORE::CPubSubClientConfig >    TMsmqPubSubClientFactory;
...
{GUCEF_TRACE;
    ...
    COMCORE::CComCoreGlobal::Instance()->GetPubSubClientFactory().UnregisterConcreteFactory( CMsmqPubSubClient::TypeName );
