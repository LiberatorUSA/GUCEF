...
CBNIX_OUTPUTDIR="$OUTPUTDIR/ECLUMAKEDBG_udp2rediscluster"

echo "*** Invoking CMake ***"
echo "Output dir for this CMake target = $CBNIX_OUTPUTDIR"
echo "CMake will use source root: $MAINCMAKE"
cmake -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=debug -G"Eclipse CDT4 - Unix Makefiles" -H"$MAINCMAKE" -B$CBNIX_OUTPUTDIR
