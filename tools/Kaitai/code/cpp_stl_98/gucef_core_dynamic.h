#ifndef GUCEF_CORE_DYNAMIC_H_
#define GUCEF_CORE_DYNAMIC_H_
...
public:
    ...
    gucef_core_dynamic_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gucef_core_dynamic_t* p__root = 0);
