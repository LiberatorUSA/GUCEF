...
#ifndef GUCEFINPUT_CONFIG_H
#include "gucefINPUT_config.h"      /* Module build configuration */
#define GUCEFINPUT_CONFIG_H
#endif /* GUCEFINPUT_CONFIG_H ? */
...
#undef GUCEF_PLUGIN_CALLSPEC_SUFFIX
#if defined ( __BORLANDC__ ) || defined ( _MSC_VER )
  #define GUCEF_CALLSPEC_PREFIX CALLSPEC_TYPE
  ...
  #define GUCEF_CALLSPEC_SUFFIX  __attribute__((CALLSPEC_TYPE))
  #define GUCEF_PLUGIN_CALLSPEC_PREFIX   
  #define GUCEF_PLUGIN_CALLSPEC_SUFFIX __attribute__((PLUGIN_CALLSPEC_TYPE)) 
#endif
