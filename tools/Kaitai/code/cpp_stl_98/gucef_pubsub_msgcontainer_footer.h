#ifndef GUCEF_PUBSUB_MSGCONTAINER_FOOTER_H_
#define GUCEF_PUBSUB_MSGCONTAINER_FOOTER_H_
...
public:
    ...
    gucef_pubsub_msgcontainer_footer_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gucef_pubsub_msgcontainer_footer_t* p__root = 0);
...
private:
    std::vector<uint32_t>* m_msg_offset_idx;
...
public:
    std::vector<uint32_t>* msg_offset_idx() const { return m_msg_offset_idx; }
...
#endif  // GUCEF_PUBSUB_MSGCONTAINER_FOOTER_H_
