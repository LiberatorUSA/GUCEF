...
void gucef_core_variant_t::_read() {
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_DATETIME_ISO8601_ASCII_STRING: {
        n_payload = false;
        m_payload = new gucef_core_dynamic_t(m__io);
        break;
    }
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_INT16: {
        n_payload = false;
        m_payload = new gucef_int16_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_FLOAT32: {
        n_payload = false;
        m_payload = new gucef_float32_t(m__io, this, m__root);
        break;
    }
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_UINT16: {
        n_payload = false;
        m_payload = new gucef_uint16_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_UINT64: {
        n_payload = false;
        m_payload = new gucef_uint64_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_INT32: {
        n_payload = false;
        m_payload = new gucef_int32_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_UINT8: {
        n_payload = false;
        m_payload = new gucef_uint8_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_UINT32: {
        n_payload = false;
        m_payload = new gucef_uint32_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_FLOAT64: {
        n_payload = false;
        m_payload = new gucef_float64_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_BE_TIMESTAMP_IN_SECS_SINCE_UNIX_EPOCH: {
        n_payload = false;
        m_payload = new gucef_be_timestamp_in_secs_since_unix_epoch_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_BE_TIMESTAMP_IN_MS_SINCE_UNIX_EPOCH: {
        n_payload = false;
        m_payload = new gucef_be_timestamp_in_ms_since_unix_epoch_t(m__io, this, m__root);
        break;
    }
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_LE_TIMESTAMP_IN_MS_SINCE_UNIX_EPOCH: {
        n_payload = false;
        m_payload = new gucef_le_timestamp_in_ms_since_unix_epoch_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_BINARY_BSOB: {
        n_payload = false;
        m_payload = new gucef_bsob_t(m__io, this, m__root);
        break;
    }
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_INT8: {
        n_payload = false;
        m_payload = new gucef_int8_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_BOOLEAN_INT32: {
        n_payload = false;
        m_payload = new gucef_boolean_int32_t(m__io, this, m__root);
        break;
    }
    case gucef_core_variant_t::GUCEF_DATATYPES_LE_TIMESTAMP_IN_SECS_SINCE_UNIX_EPOCH: {
        n_payload = false;
        m_payload = new gucef_le_timestamp_in_secs_since_unix_epoch_t(m__io, this, m__root);
        break;
    }
    ...
    case gucef_core_variant_t::GUCEF_DATATYPES_INT64: {
        n_payload = false;
        m_payload = new gucef_int64_t(m__io, this, m__root);
        break;
    }
