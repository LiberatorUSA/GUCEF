 ...
 */
  ...
  #define GUCEF_MT_EXPORTSPEC GUCEF_HIDDEN
#else
...
#define GUCEF_MT_EXTRA_LONG_LOCK_TIMEOUT        2500
#define GUCEF_MT_SUPER_LONG_LOCK_TIMEOUT        60000
#define GUCEF_MT_MEGA_LONG_LOCK_TIMEOUT         150000
#define GUCEF_MT_ULTRA_LONG_LOCK_TIMEOUT        300000
#define GUCEF_MT_INFINITE_LOCK_TIMEOUT          GUCEF_MT_UINT32MAX

#define GUCEF_MT_DEFAULT_LOCK_TIMEOUT_IN_MS     GUCEF_MT_SUPER_LONG_LOCK_TIMEOUT
