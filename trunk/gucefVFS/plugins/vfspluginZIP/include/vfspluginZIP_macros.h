...
#ifndef GUCEF_VFSPLUGIN_ZIP_CONFIG_H
#include "vfspluginZIP_config.h"
#define GUCEF_VFSPLUGIN_ZIP_CONFIG_H
#endif /* GUCEF_VFSPLUGIN_ZIP_CONFIG_H ? */
...
#undef GUCEF_VFSPLUGIN_ZIP_EXPORT
#ifdef GUCEF_VFSPLUGIN_ZIP_BUILD_MODULE
  #define GUCEF_VFSPLUGIN_ZIP_EXPORT GUCEF_EXPORT
#else
  #define GUCEF_VFSPLUGIN_ZIP_EXPORT GUCEF_IMPORT
#endif /* GUCEF_VFSPLUGIN_ZIP_BUILD_MODULE ? */
...
#else
  #define GUCEF_VFSPLUGIN_ZIP_EXPORT_C
#endif /* GUCEF_VFSPLUGIN_ZIP_EXPORT_C_CODE */
