...
public:
    ...
    gucef_pubsub_msgcontainer_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, gucef_pubsub_msgcontainer_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        gucef_pubsub_msg_t(kaitai::kstream* p__io, gucef_pubsub_msgcontainer_t* p__parent = nullptr, gucef_pubsub_msgcontainer_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<gucef_core_variant_t> m_msgid;
        bool n_msgid;
    ...
    private:
        std::unique_ptr<gucef_core_variant_t> m_msg_index;
        bool n_msg_index;
    ...
    private:
        std::unique_ptr<gucef_core_variant_t> m_primary_payload_included;
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<kv_pair_t>>> m_key_value_pairs;
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<kv_pair_t>>> m_metadata_key_value_pairs;
    ...
    public:
        ...
        gucef_core_variant_t* msgid() const { return m_msgid.get(); }
        gucef_core_variant_t* msg_index() const { return m_msg_index.get(); }
        gucef_core_variant_t* primary_payload_included() const { return m_primary_payload_included.get(); }
        uint32_t nr_of_kv_pairs() const { return m_nr_of_kv_pairs; }
        std::vector<std::unique_ptr<kv_pair_t>>* key_value_pairs() const { return m_key_value_pairs.get(); }
        uint32_t nr_of_metadata_kv_pairs() const { return m_nr_of_metadata_kv_pairs; }
        std::vector<std::unique_ptr<kv_pair_t>>* metadata_key_value_pairs() const { return m_metadata_key_value_pairs.get(); }
    ...
    public:
        ...
        kv_pair_t(kaitai::kstream* p__io, gucef_pubsub_msgcontainer_t::gucef_pubsub_msg_t* p__parent = nullptr, gucef_pubsub_msgcontainer_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<gucef_core_variant_t> m_key;
        std::unique_ptr<gucef_core_variant_t> m_value;
        gucef_pubsub_msgcontainer_t* m__root;
        gucef_pubsub_msgcontainer_t::gucef_pubsub_msg_t* m__parent;

    public:
        gucef_core_variant_t* key() const { return m_key.get(); }
        gucef_core_variant_t* value() const { return m_value.get(); }
        gucef_pubsub_msgcontainer_t* _root() const { return m__root; }
...
private:
    std::unique_ptr<gucef_pubsub_msgcontainer_header_t> m_header;
    std::unique_ptr<std::vector<std::unique_ptr<gucef_pubsub_msg_t>>> m_pubsubmsg;
    std::unique_ptr<gucef_pubsub_msgcontainer_footer_t> m_footer;
    gucef_pubsub_msgcontainer_t* m__root;
    kaitai::kstruct* m__parent;

public:
    gucef_pubsub_msgcontainer_header_t* header() const { return m_header.get(); }
    std::vector<std::unique_ptr<gucef_pubsub_msg_t>>* pubsubmsg() const { return m_pubsubmsg.get(); }
    gucef_pubsub_msgcontainer_footer_t* footer() const { return m_footer.get(); }
    gucef_pubsub_msgcontainer_t* _root() const { return m__root; }
