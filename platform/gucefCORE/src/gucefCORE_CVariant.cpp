...
CVariant::CVariant( const CVariant& src )
    : m_variantData()
{GUCEF_TRACE;
...
{GUCEF_TRACE;
    ...
    switch ( m_variantData.containedType )
    {
        ...
        case GUCEF_DATATYPE_BOOLEAN_ASCII_STRING: return AsBool() ? 1.0 : 0.0;
        case GUCEF_DATATYPE_BOOLEAN_UTF8_STRING: return AsBool() ? 1.0 : 0.0;
        default: return 0;
    }
}
