...
#$GENERATORPATH *rootDir=$GUCEF_HOME* *dirsToIgnore=.svn* *projectName=GUCEF* *generators=premake4* *outputDir=$GUCEF_HOME* *premake4gen:TemplateDir=$GUCEF_HOME/projects/premake4/ProjectGenTemplates*
