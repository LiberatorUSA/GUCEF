 ...
 */
class PUBSUBPLUGIN_WEB_PLUGIN_PRIVATE_CPP CWebPubSubClientConfig : public PUBSUB::CPubSubClientConfig
{
    public:
    ...
    CWebPubSubClientConfig( const PUBSUB::CPubSubClientConfig& genericConfig );
