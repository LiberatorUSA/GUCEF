...
class GUCEF_CORE_PUBLIC_CPP CObserverScopeLock
{
     ...
     *  throws timeout_exception if unable to attain the lock before the specified timeout
     */
    CObserverScopeLock( const CIObserver* lockableObserver, UInt32 lockWaitTimeoutInMs = GUCEF_MT_DEFAULT_LOCK_TIMEOUT_IN_MS );
...
class GUCEF_CORE_PUBLIC_CPP CObserverScopeReadOnlyLock
{
     ...
     *  throws timeout_exception if unable to attain the lock before the specified timeout
     */
    CObserverScopeReadOnlyLock( const CIObserver* lockableNotifier, UInt32 lockWaitTimeoutInMs = GUCEF_MT_DEFAULT_LOCK_TIMEOUT_IN_MS );
