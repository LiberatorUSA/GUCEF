...
typedef CORE::CTFactoryWithParam< COMCORE::CPubSubClient, CStoragePubSubClient, COMCORE::CPubSubClientConfig >    TStoragePubSubClientFactory;
...
{GUCEF_TRACE;
    ...
    COMCORE::CComCoreGlobal::Instance()->GetPubSubClientFactory().RegisterConcreteFactory( CStoragePubSubClient::TypeName, &g_storagePubSubClientFactory );
...
{GUCEF_TRACE;
    ...
    COMCORE::CComCoreGlobal::Instance()->GetPubSubClientFactory().UnregisterConcreteFactory( CStoragePubSubClient::TypeName );
