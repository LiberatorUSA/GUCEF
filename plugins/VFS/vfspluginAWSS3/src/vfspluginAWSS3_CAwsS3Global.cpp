...
{GUCEF_TRACE;
    ...
    try
    {
        ...
        m_s3Client = GUCEF_NEW Aws::S3::S3Client( sdk->GetCredentialsProvider(), sdk->GetDefaultAwsClientConfig(), Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy::RequestDependent, true );
