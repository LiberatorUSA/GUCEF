...
configuration( { "WIN32" } )
includedirs( { "../../../dependencies/aws-cpp-sdk-core/include/aws/core/http/windows", "../../../platform/gucefCORE/include/mswin" } )
