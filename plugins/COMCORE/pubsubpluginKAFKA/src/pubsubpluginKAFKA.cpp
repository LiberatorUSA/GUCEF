...
typedef CORE::CTFactoryWithParam< COMCORE::CPubSubClient, CKafkaPubSubClient, COMCORE::CPubSubClientConfig >    TKafkaPubSubClientFactory;
...
{GUCEF_TRACE;
    ...
    COMCORE::CComCoreGlobal::Instance()->GetPubSubClientFactory().RegisterConcreteFactory( CKafkaPubSubClient::TypeName, &g_kafkaClusterPubSubClientFactory );
...
{GUCEF_TRACE;
    ...
    COMCORE::CComCoreGlobal::Instance()->GetPubSubClientFactory().UnregisterConcreteFactory( CKafkaPubSubClient::TypeName );
