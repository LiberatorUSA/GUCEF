...
{GUCEF_TRACE;
    ...
    PUBSUB::CComCoreGlobal::Instance()->GetPubSubClientFactory().RegisterConcreteFactory( CRedisClusterPubSubClient::TypeName, &g_redisClusterPubSubClientFactory );
...
{GUCEF_TRACE;
    ...
    PUBSUB::CComCoreGlobal::Instance()->GetPubSubClientFactory().UnregisterConcreteFactory( CRedisClusterPubSubClient::TypeName );
