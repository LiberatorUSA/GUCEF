...
%GENERATOREXE% *rootDir=%GUCEF_HOME%* *dirsToIgnore=.svn;_svn* *projectName=GUCEF* *generators=premake4* *outputDir=%GUCEF_HOME%* *premake4gen:TemplateDir=%GUCEF_HOME%\projects\premake4\ProjectGenTemplates*
cd "%GUCEF_THEBATCHDIR%"
GOTO END
