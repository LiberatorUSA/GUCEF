...
{GUCEF_TRACE;
	...
	{
		GUCEF_ERROR_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Couldn't find board " + CORE::ToString( (Int64)nicIndex ) );
		return false;
	}
	...
	if ( 0 != openResult )
	{
		GUCEF_ERROR_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Cannot open board " + CORE::ToString( (Int64)nicIndex ) );
		return false;
	}
	...
	if ( 0 != queryResult )
	{
		GUCEF_ERROR_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Failed to get driver id for board " + CORE::ToString( (Int64)nicIndex ) );
	...
	if ( 0 != queryResult )
	{
		...
		GUCEF_WARNING_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Cannot get port count for board " + CORE::ToString( (Int64)nicIndex ) );
	}
	...
	if ( 0 != queryResult )
	{
		GUCEF_ERROR_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Failed to get nr of counter stats for board " + CORE::ToString( (Int64)nicIndex ) );
		dblwrapper_mal_close( deviceContext );
		return false;
	}
	...
	{
		GUCEF_ERROR_LOG( CORE::LOGLEVEL_IMPORTANT, "DBLNetworkInterface: Failed to allocate memory to store counter stats for board " + CORE::ToString( (Int64)nicIndex ) );
		dblwrapper_mal_close( deviceContext );
		return false;
	}
