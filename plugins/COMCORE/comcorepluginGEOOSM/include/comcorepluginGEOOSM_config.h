...
/* #define COMCOREPLUGIN_GEOOSM_PUBLIC_CPP_CODE */
/* #define COMCOREPLUGIN_GEOOSM_PUBLIC_C_CODE */

/* #define COMCOREPLUGIN_GEOOSM_PLUGIN_PUBLIC_CPP_CODE */
#define COMCOREPLUGIN_GEOOSM_PLUGIN_PUBLIC_C_CODE
