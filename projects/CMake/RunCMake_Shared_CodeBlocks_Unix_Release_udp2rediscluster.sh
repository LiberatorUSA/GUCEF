...
MAINCMAKE=$SRCROOTDIR/projects/CMake/targets/GUCEF_exe_udp2rediscluster
CBNIX_OUTPUTDIR="$OUTPUTDIR/CBNIXRELEASE_udp2rediscluster"

echo "*** Invoking CMake ***"
echo "Output dir for this CMake target = $CBNIX_OUTPUTDIR"
echo "CMake will use source root: $MAINCMAKE"
cmake -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=release -G"CodeBlocks - Unix Makefiles" -H"$MAINCMAKE" -B$CBNIX_OUTPUTDIR
