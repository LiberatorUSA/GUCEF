...
GUCEF_CODEC_EXPORT_C NSVersion GUCEF_PLUGIN_CALLSPEC_PREFIX
...
CODECPLUGIN_GetCodecLink( void* plugdata                ,
                          void* iterator                ,
                          NSCodecPluginLink** codecLink ) GUCEF_PLUGIN_CALLSPEC_SUFFIX;
