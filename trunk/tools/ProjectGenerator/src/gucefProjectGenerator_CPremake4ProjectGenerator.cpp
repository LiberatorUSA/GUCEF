...
CORE::CString
GeneratePremake4ListsFileSection( const CORE::CString& sectionContent ,
...
{GUCEF_TRACE;
    ...
    CORE::CString sectionContent = GeneratePremake4ListsModuleNameSection( moduleInfoEntry );
...
{GUCEF_TRACE;
    ...
    while ( i != projectInfo.modules.end() )
    {
             ...
             ( MODULETYPE_CODE_INCLUDE_LOCATION != allPlatformsType )    )
        {
            ...
            CORE::AppendToPath( pathToCMakeListsFile, "ModuleInfo.premake4" );
