 ...
 */
class CDRNControllerTCPPeerComHandler : public COM::CBPTCPServerSocketInterface
{
        public:
        
        CDRNControllerTCPPeerComHandler( CDRNController* controller );
        ...
        private:
        CDRNControllerTCPPeerComHandler( void );
        CDRNControllerTCPPeerComHandler( const CDRNControllerTCPPeerComHandler& src );
