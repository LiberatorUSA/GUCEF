...
class PUBSUBPLUGIN_KAFKA_PLUGIN_PRIVATE_CPP CKafkaPubSubClient : public COMCORE::CPubSubClient
{
    public:

    static const CORE::CString TypeName; 

    CKafkaPubSubClient( const COMCORE::CPubSubClientConfig& config );
