...
{GUCEF_TRACE;
    ...
    GenerateCMakeListsContentForModules( projectInfo, addToolCompileTimeToOutput );

    bool writeLogLocationToOutput = CORE::StringToBool( keyValueList.GetValueAlways( "writeLogLocationToOutput" ) );
