...
#undef GUCEF_LOADER_EXPORT_CPP
#ifdef GUCEF_LOADER_EXPORT_CPP_CODE
  #define GUCEF_LOADER_EXPORT_CPP GUCEF_LOADER_EXPORTSPEC
#else
  #define GUCEF_LOADER_EXPORT_CPP
#endif /* GUCEF_LOADER_EXPORT_CPP_CODE */

#undef GUCEF_LOADER_EXPORT_C
#ifdef GUCEF_LOADER_EXPORT_C_CODE
  #define GUCEF_LOADER_EXPORT_C GUCEF_LOADER_EXPORTSPEC
#else
  #define GUCEF_LOADER_EXPORT_C
