...
configuration( { LINUX32 } )
defines( { "FREEIMAGE_EXPORTS", "LIBRAW_LIBRARY_BUILD", "LIBRAW_NODLL", "NO_JASPER", "OPJ_STATIC", "USE_JPIP", "ZENO_STATIC" } )
...
configuration( { WIN32 } )
defines( { "FREEIMAGE_EXPORTS", "LIBRAW_LIBRARY_BUILD", "LIBRAW_NODLL", "NO_JASPER", "OPJ_STATIC", "USE_JPIP", "ZENO_STATIC", "_CRT_SECURE_NO_WARNINGS" } )
