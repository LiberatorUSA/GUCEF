#ifndef GUCEF_PUBSUB_MSGCONTAINER_HEADER_H_
#define GUCEF_PUBSUB_MSGCONTAINER_HEADER_H_
...
public:
    ...
    gucef_pubsub_msgcontainer_header_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gucef_pubsub_msgcontainer_header_t* p__root = 0);
...
#endif  // GUCEF_PUBSUB_MSGCONTAINER_HEADER_H_
