...
{GUCEF_TRACE;
    ...
    "#      CMAKE_MODULE_PATH\n"
    "#      â€“ Path to where the CMake modules are located\n"
    "#      CMAKE_INSTALL_PREFIX\n"
    "#      â€“ Where to put files when calling 'make install'\n"
    "#      CMAKE_BUILD_TYPE\n"
    "#      â€“ Type of build (Debug, Release, ...)\n"
    "#      BUILD_SHARED_LIBS\n"
    "#      â€“ Switch between shared and static libraries\n";
    "#\n"
