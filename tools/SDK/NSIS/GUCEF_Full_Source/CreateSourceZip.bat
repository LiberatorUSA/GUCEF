...
%ZIPTOOLDIR%\zip.exe -d %ZIPOUTPUTDIR%\GUCEF_FULL_SOURCE.zip "GUALL/GUCEF/gucefCORE/bin\*" "GUALL/GUCEF/gucefMT/bin\*" "GUALL/GUCEF/gucefAUDIO/bin\*" "GUALL/GUCEF/gucefCOM/bin\*" "GUALL/GUCEF/gucefCOM_TextApp/bin\*" "GUALL/GUCEF/gucefCOMCORE/bin\*" "GUALL/GUCEF/gucefCOMCORE_TestApp/bin\*" "GUALL/GUCEF/gucefCORE_TestApp/bin\*"  "GUALL/GUCEF/gucefDRN/bin\*" "GUALL/GUCEF/gucefDRN_TestApp/bin\*" "GUALL/GUCEF/gucefGUI/bin\*" "GUALL/GUCEF/gucefIMAGE/bin\*" "GUALL/GUCEF/gucefIMAGE_TestApp/bin\*" "GUALL/GUCEF/gucefINPUT/bin\*" "GUALL/GUCEF/gucefINPUT_TestApp/bin\*" "GUALL/GUCEF/gucefMATH/bin\*" "GUALL/GUCEF/gucefMT_TestApp/bin\*" "GUALL/GUCEF/gucefPATCHER/bin\*" "GUALL/GUCEF/gucefVFS/bin\*" "GUALL/GUCEF/gucefVFS_TestApp/bin\*" "GUALL/GUCEF/common/bin/Debug*" "GUALL/GUCEF/common/bin/Release*" "GUALL/GUCEF/common/docs/API\*"
