...
MAINCMAKE=$SRCROOTDIR/projects/CMake/targets/GUCEF_tag_platform
CBNIX_OUTPUTDIR="$OUTPUTDIR/CBNIX_Platform"

echo "*** Invoking CMake ***"
echo "Output dir for this CMake target = $CBNIX_OUTPUTDIR"
echo "CMake will use source root: $MAINCMAKE"
cmake -DBUILD_SHARED_LIBS=ON -G"CodeBlocks - Unix Makefiles" -H"$MAINCMAKE" -B$CBNIX_OUTPUTDIR
