...
CBNIX_OUTPUTDIR="$OUTPUTDIR/CLNIXDBG_udp2rediscluster"

echo "*** Invoking CMake ***"
echo "Output dir for this CMake target = $CBNIX_OUTPUTDIR"
echo "CMake will use source root: $MAINCMAKE"
cmake -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=debug -G"CodeLite - Unix Makefiles" -H"$MAINCMAKE" -B$CBNIX_OUTPUTDIR
