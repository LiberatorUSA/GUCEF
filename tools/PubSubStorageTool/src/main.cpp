...
{GUCEF_TRACE;
    ...
    const CORE::CString bootstrapConfigFile = "PubSubStorageTool_bootstrap_d.ini";
    const CORE::CString configFile = "PubSubStorageTool_d.ini";
    #else
    const CORE::CString bootstrapConfigFile = "PubSubStorageTool_bootstrap.ini";
    const CORE::CString configFile = "PubSubStorageTool.ini";
    #endif
...
{GUCEF_TRACE;
    ...
    CORE::CString logFilename = CORE::CombinePath( outputDir, "PubSubStorageTool_Log.txt" );
    ...
    pubSubStorageTool.SetConsoleAccess( console );

    CORE::CCoreGlobal::Instance()->GetLogManager().FlushBootstrapLogEntriesToLogs();
    GUCEF_LOG( CORE::LOGLEVEL_NORMAL, "Flushed to log @ " + logFilename );

    pubSubStorageTool.SetParams( keyValueList );
