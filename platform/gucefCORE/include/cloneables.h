...
typedef CTCloneableObj< CString::StringPair >       TCloneableStringPair;
...
typedef CTCloneableObj< CString::StringMap >        TCloneableStringMap;
...
typedef CTCloneableObj< Float32 >                   TCloneableFloat32;
typedef CTCloneableObj< Float64 >                   TCloneableFloat64;
