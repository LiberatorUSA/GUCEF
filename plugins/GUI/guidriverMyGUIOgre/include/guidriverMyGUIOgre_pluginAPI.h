...
#ifndef GUCEF_MYGUIOGRE_PLUGINAPI_H
#define GUCEF_MYGUIOGRE_PLUGINAPI_H
...
GUCEF_MYGUIOGRE_EXPORT_C GUCEF::CORE::Int32 GUCEF_PLUGIN_CALLSPEC_PREFIX 
GUCEFPlugin_Load( GUCEF::CORE::UInt32 argc, const char** argv ) GUCEF_PLUGIN_CALLSPEC_SUFFIX;

/*--------------------------------------------------------------------------*/

GUCEF_MYGUIOGRE_EXPORT_C void GUCEF_PLUGIN_CALLSPEC_PREFIX 
...
GUCEF_MYGUIOGRE_EXPORT_C const char* GUCEF_PLUGIN_CALLSPEC_PREFIX 
...
#endif /* GUCEF_MYGUIOGRE_PLUGINAPI_H ? */
