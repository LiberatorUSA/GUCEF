...
const CString CValueConstraint::ClassTypeName = "GUCEF::CORE::CValueConstraint";
...
CICloneable* 
CValueConstraint::Clone( void ) const
{GUCEF_TRACE;

    return new CValueConstraint( *this );
}

/*-------------------------------------------------------------------------*/

const CString& 
CValueConstraint::GetClassTypeName( void ) const
{GUCEF_TRACE;
