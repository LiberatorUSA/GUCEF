 ...
 */
class PUBSUBPLUGIN_UDP_PLUGIN_PRIVATE_CPP CUdpPubSubClientConfig : public PUBSUB::CPubSubClientConfig
{
    public:

    CUdpPubSubClientConfig( void );
    
    CUdpPubSubClientConfig( const PUBSUB::CPubSubClientConfig& genericConfig );
